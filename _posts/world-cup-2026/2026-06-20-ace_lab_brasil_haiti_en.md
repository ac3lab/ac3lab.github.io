...
tags: Football; World Cup; Brazil; Haiti;
categories: Sports; Analysis
thumbnail: assets/img/Posts_Images/2026-06-09-world-cup-2026/thumbnail.png
author: Ace Laboratory Team - Pedro Martins e Pedro Lopes
---

---

<p align="justify">
Se quiser ler este texto em pt-br, <a href="https://ac3lab.github.io/blog/2026/ace_lab_brasil_haiti_pt/">clique aqui.</a>
</p>
...
<h3><b>First Half: Tactical Fit, Goals, and Raphinha's Injury</b></h3>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-20-brasil-haiti/brazil-vs-haiti_Brazil_passing_network_bidirectional.svg" title="Passing Network - Brazil" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figure 1: Passing Network - Brazil<br/><br/></center>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-20-brasil-haiti/brazil-vs-haiti_Haiti_passing_network_bidirectional.svg" title="Passing Network - Haiti" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figure 2: Passing Network - Haiti<br/><br/></center>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-20-brasil-haiti/ppda_map_Haiti_en.png" title="PPDA Map - Haiti" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figure 3: PPDA Map - Haiti<br/><br/></center>
...
<h3><b>Second Half: Lead Management and Physical Conservation</b></h3>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-20-brasil-haiti/ppda_map_Brazil_en (1).png" title="PPDA Map - Brazil" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figure 4: PPDA Map - Brazil<br/><br/></center>
