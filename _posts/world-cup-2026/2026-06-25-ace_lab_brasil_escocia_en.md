...
tags: Football; World Cup; Brazil; Scotland;
...
<p align="justify">
If you want to read this text in pt-br, <a href="https://ac3lab.github.io/blog/2026/ace_lab_brasil_escocia_pt/">click here.</a>
</p>
...
<h3><b>First Half: Pressing Triggers and Vini Jr.'s Freedom</b></h3>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-25-brasil-escocia/ppda_map_Scotland_en.png" title="Scotland's PPDA Map" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figure 1: Scotland's PPDA Map<br/><br/></center>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-25-brasil-escocia/scotland-vs-brazil_Brazil_passing_network_bidirectional.svg" title="Brazil's Pass Network" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figure 2: Brazil's Pass Network<br/><br/></center>
...
<h3><b>Second Half: Fast Transitions, Defensive Control, and Neymar's Return</b></h3>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-25-brasil-escocia/scotland-vs-brazil_Scotland_passing_network_bidirectional.svg" title="Scotland's Pass Network" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figure 3: Scotland's Pass Network<br/><br/></center>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-25-brasil-escocia/ppda_map_Brazil_en (2).png" title="Brazil's PPDA Map" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figure 4: Brazil's PPDA Map<br/><br/></center>
