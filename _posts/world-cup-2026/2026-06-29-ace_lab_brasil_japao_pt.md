...
tags: Football; World Cup; Brasil; Japão;
...
<p align="justify">
If you want to read this text in en-us, <a href="https://ac3lab.github.io/blog/2026/ace_lab_brasil_japao_en/">click here.</a>
</p>
...
<h3><b>Primeiro Tempo: Controle ilusório e a punição do bloco baixo</b></h3>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-29-brasil-japao/ppda_map_Japan_pt.png" title="Mapa de PPDA - Japão" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-29-brasil-japao/brazil-vs-japan_Japan_passing_network_bidirectional.svg" title="Rede de Passes do Japão" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-29-brasil-japao/ppda_map_Brazil_pt (3).png" title="Mapa de PPDA do Brasil" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figura 3: Mapa de PPDA do Brasil<br/><br/></center>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-29-brasil-japao/brazil-vs-japan_Brazil_passing_network_bidirectional.svg" title="Rede de Passes do Brasil" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figura 4: Rede de Passes do Brasil<br/><br/></center>
