...
<p align="justify">
Se quiser ler esse texto em pt-br, <a href="https://ac3lab.github.io/blog/2026/canada_marocco-france_paraguay_pt/">clique aqui.</a>
</p>

<style>body {text-align: justify}</style>

<h2><b>Canada x Morocco</b></h2>
...
<h3><b>First Half: High-pressing Canada and physical parity</b></h3>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-07-05-canada-morocco/ppda_map_Canada_en.png" title="Canada's PPDA Map" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figure 1: Canada's PPDA Map<br/><br/></center>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-07-05-canada-morocco/ppda_map_Morocco_en.png" title="Morocco's PPDA Map" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figure 2: Morocco's PPDA Map<br/><br/></center>

<h3><b>Second Half: Canadian fatigue and Morocco's lethal efficiency</b></h3>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-07-05-canada-morocco/canada-vs-morocco_Morocco_passing_network_bidirectional.svg" title="Morocco's Passing Network" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figure 3: Morocco's Passing Network<br/><br/></center>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-07-05-canada-morocco/canada-vs-morocco_Canada_passing_network_bidirectional.svg" title="Canada's Passing Network" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figure 4: Canada's Passing Network<br/><br/></center>
...
<h3><b>First Half: High tension and the South American low block</b></h3>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-07-05-france-paraguay/ppda_map_Paraguay_en.png" title="Paraguay's PPDA Map" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figure 5: Paraguay's PPDA Map<br/><br/></center>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-07-05-france-paraguay/ppda_map_France_en.png" title="France's PPDA Map" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figure 6: France's PPDA Map<br/><br/></center>

<h3><b>Second Half: Monopoly of possession and the fatal mistake</b></h3>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-07-05-france-paraguay/paraguay-vs-france_France_passing_network_bidirectional.svg" title="France's Passing Network" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figure 7: France's Passing Network<br/><br/></center>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-07-05-france-paraguay/paraguay-vs-france_Paraguay_passing_network_bidirectional.svg" title="Paraguay's Passing Network" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figure 8: Paraguay's Passing Network<br/><br/></center>
