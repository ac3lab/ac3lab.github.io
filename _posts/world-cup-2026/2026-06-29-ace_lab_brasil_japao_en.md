...
tags: Football; World Cup; Brazil; Japan;
...
<p align="justify">
Se quiser ler este texto em pt-br, <a href="https://ac3lab.github.io/blog/2026/ace_lab_brasil_japao_pt/">clique aqui.</a>
</p>
...
<h3><b>First Half: Illusory control and the punishment of the low block</b></h3>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-29-brasil-japao/ppda_map_Japan_en.png" title="Japan's PPDA Map" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figure 1: Japan's PPDA Map<br/><br/></center>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-29-brasil-japao/brazil-vs-japan_Japan_passing_network_bidirectional.svg" title="Japan's Passing Network" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figure 2: Japan's Passing Network<br/><br/></center>
...
<h3><b>Second Half: Plan B, the aerial game, and redemption at the end</b></h3>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-29-brasil-japao/ppda_map_Brazil_en (3).png" title="Brazil's PPDA Map" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figure 3: Brazil's PPDA Map<br/><br/></center>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-29-brasil-japao/brazil-vs-japan_Brazil_passing_network_bidirectional.svg" title="Brazil's Passing Network" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figure 4: Brazil's Passing Network<br/><br/></center>
