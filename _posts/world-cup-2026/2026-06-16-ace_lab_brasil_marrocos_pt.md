...
<p align="justify">
If you want to read this text in en-us, <a href="https://ac3lab.github.io/blog/2026/ace_lab_brasil_marrocos_en/">click here.</a>
</p>
...
<h2><b>Resumo da Partida</b></h2>

<h3><b>Primeiro Tempo: Dificuldades Iniciais, Sustos e Reação</b></h3>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-16-brasil-marrocos/ppda_map_Morocco_pt.png" title="Mapa de PPDA - Marrocos" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figura 1: Mapa de PPDA - Marrocos<br/><br/></center>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-16-brasil-marrocos/brazil-vs-morocco_Brazil_passing_network_bidirectional.png" title="Rede de passes - Brasil" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<h3><b>Segundo Tempo: Mudanças de Peças, Variação Tática e Equilíbrio</b></h3>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-16-brasil-marrocos/brazil-vs-morocco_Morocco_passing_network_bidirectional.png" title="Rede de passes - Marrocos" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figura 3: Rede de passes - Marrocos<br/><br/></center>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-16-brasil-marrocos/ppda_map_Brazil_pt.png" title="Mapa de PPDA - Brasil" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figura 4: Mapa de PPDA - Brasil<br/><br/></center>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-16-brasil-marrocos/sentimentos_en.png" title="Análise de Sentimento" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figura 5: Análise de Sentimento<br/><br/></center>

<ul>
  <li>
    <b>Pré-jogo e Início:</b> Antes mesmo do apito inicial, havia uma grande empolgação e otimismo, com o saldo de mensagens atingindo um pico de positividade superior a 300. Esse otimismo começou a minguar após o início da partida, conforme as dificuldades do Brasil ficavam evidentes.
  </li>
    <br>
  <li>
        <b>Baques do Primeiro Tempo:</b> O momento de maior frustração da primeira etapa coincidiu diretamente com o gol da seleção marroquina. O sentimento despencou abruptamente para a zona negativa, beirando a marca de -200. Embora o gol de empate brasileiro tenha oferecido uma sobrevida passageira, a desconfiança pesou, e o saldo continuou predominantemente negativo até a chegada do intervalo.
  </li>
    <br>
  <li>
    <b>Recuperação e Queda Final:</b> O início da segunda etapa e as mudanças táticas restauraram temporariamente a confiança dos torcedores, o que se traduziu em um bloco consistente de saldo positivo. No entanto, à medida que o tempo avançava sem que a virada se concretizasse, a frustração retornou. Ao soar do apito final, especialmente após o susto dos 98 minutos, o sentimento despencou novamente para um vermelho profundo, consolidando a insatisfação generalizada com o empate.
  </li>
</ul>
