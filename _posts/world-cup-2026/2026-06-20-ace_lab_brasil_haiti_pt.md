...
tags: Football; World Cup; Brasil; Haiti;
...
<p align="justify">
If you want to read this text in en-us, <a href="https://ac3lab.github.io/blog/2026/ace_lab_brasil_haiti_en/">click here.</a>
</p>
...
<h3><b>Primeiro Tempo: Encaixe Tático, Gols e a Baixa de Raphinha</b></h3>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-20-brasil-haiti/brazil-vs-haiti_Brazil_passing_network_bidirectional.svg" title="Rede de passes - Brasil" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figura 1: Rede de passes - Brasil<br/><br/></center>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-20-brasil-haiti/brazil-vs-haiti_Haiti_passing_network_bidirectional.svg" title="Rede de passes - Haiti" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figura 2: Rede de passes - Haiti<br/><br/></center>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-20-brasil-haiti/ppda_map_Haiti_pt.png" title="Mapa de PPDA - Haiti" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<center>Figura 3: Mapa de PPDA - Haiti<br/><br/></center>
...
<div style="display: flex; justify-content: center;">
    <div class="col-sm mt-3 mt-md-0" style="max-width: 600px; width: 100%;">
        {% include figure.liquid loading="eager" path="assets/img/Posts_Images/2026-06-20-brasil-haiti/ppda_map_Brazil_pt (1).png" title="Mapa de PPDA - Brasil" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
